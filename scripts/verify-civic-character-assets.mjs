...
assert.equal(manifest.sculptContract, "mirrorlife-civic-sculpt-v40", "civic character sculpt contract is stale");
...
assert.equal(manifest.faceDecal?.productionIntegrationContract, "mirrorlife-civic-face-illustrated-cornea-v2", "civic production facial integration contract is stale");
