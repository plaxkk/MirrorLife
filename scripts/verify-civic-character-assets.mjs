...
assert.equal(manifest.sculptContract, "mirrorlife-civic-sculpt-v39", "civic character sculpt contract is stale");
...
assert.equal(manifest.faceDecal?.integrationContract, "mirrorlife-civic-face-volume-v10", "civic facial volume integration contract is stale");
assert.equal(manifest.faceDecal?.productionIntegrationContract, "mirrorlife-civic-face-uv-hybrid-v1", "civic production facial integration contract is stale");
