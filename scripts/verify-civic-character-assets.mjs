...
assert.equal(manifest.sculptContract, "mirrorlife-civic-sculpt-v21", "civic character sculpt contract is stale");
...
assert.equal(manifest.faceDecal?.integrationContract, "mirrorlife-civic-face-volume-v2", "civic facial volume integration contract is stale");
assert.deepEqual(manifest.faceDecal?.preservedSculptParts, ["Head", "NoseBridge", "NoseTip"], "civic sculpted facial parts changed");
