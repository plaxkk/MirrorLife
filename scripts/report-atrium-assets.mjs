...
const sourceFiles=['atrium.html','src/atrium-main.js','src/atrium-actors.js','src/atrium-floor-contact.js','src/atrium-assets.js','src/atrium-content.js','src/atrium-physics.js','src/atrium-persistence.js','src/atrium.css','src/civic-animation-clips.js','src/reference-fidelity-runtime-contract.js','public/storage.js'];
