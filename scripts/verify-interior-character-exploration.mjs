...
try {
  ...
  assert(opening.actors.every((actor) => actor.facial?.integration === "mirrorlife-civic-face-volume-v7"), "civic actors did not preserve the production sculpted facial volume contract");
