...
This is an anatomical starting mesh, not a likeness reconstructed from the atrium reference. The reference's small faces do not supply exact facial geometry. MirrorLife adapts the head to its own stylized residents, rig and palette. The full body and genital/helper meshes are not included.
