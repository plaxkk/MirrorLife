# MirrorLife asset library

Public game assets live here so they can be referenced from the browser with
`/assets/<file-name>`.
...
bold ink line, bright flat color, light paper background, and soft grounding
shadow.
